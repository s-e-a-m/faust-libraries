...
//-------------------------------------------------------------- VOICED UNVOICED
threshold = hslider("[2] Threshold", 0.9, 0, 10.000, 0.001);
insp1 = hbargraph("insp1",-20,20);
insp2 = hbargraph("insp2",-5,5);
process = _ <: de.delay(512,500),
          (_<: *(_,_') < (0) : slidingSumN(500,512) : *(0.10) : insp2 : > (threshold) : * (1.570796) <: cos, sin : si.smoo, si.smoo),
               de.delay(512,500) : *,*;
