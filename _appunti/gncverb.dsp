...
// PRE-DELAY
pdly = if_g(int(vslider("[03]PREDELAY[style:knob]", 1,1,100,0.1)/1000 : ba.sec2samp));
mpdl = ba.sec2samp(0.11) : int; 
predelay(pdly) = de.delay(mpdl,pdly);
...
process = _*(0.707) <:_, (input_filters(ihip,ilop) : predelay(pdly) : fragmentation : density <: asumL, asumR);// : mixer;